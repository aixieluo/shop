...
func (*Registry_Consul) Descriptor() ([]byte, []int) {
	return file_conf_registry_proto_rawDescGZIP(), []int{1, 0}
}
...
var file_conf_registry_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e,
	0x63, 0x6f, 0x6e, 0x66, 0x22, 0x23, 0x0a, 0x05, 0x54, 0x72, 0x61, 0x63, 0x65, 0x12, 0x1a, 0x0a,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	...
	0x09, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x42, 0x26, 0x0a, 0x0d, 0x69, 0x6e, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x50, 0x01, 0x5a, 0x13, 0x2f, 0x69,
...
var file_conf_registry_proto_goTypes = []interface{}{
	(*Trace)(nil),           // 0: internal.conf.Trace
	(*Registry)(nil),        // 1: internal.conf.Registry
	(*Registry_Consul)(nil), // 2: internal.conf.Registry.Consul
}
var file_conf_registry_proto_depIdxs = []int32{
	2, // 0: internal.conf.Registry.consul:type_name -> internal.conf.Registry.Consul
